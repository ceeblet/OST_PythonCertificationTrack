...
class TestAddresses(unittest.TestCase): 
    ...
    def setUp(self): 
        self.home = Address( name='Steve Holden', street_address='1972 Flying Circus', city='Arlington', state='VIR', zip_code='12345-3425' )
    ...
    def test_zip_code(self): 
        self.assertEqual(self.home.zip_code, '12345-3425') 
        self.assertRaises(ZipCodeError, setattr, self.home, 'zip_code', '123456')   
        self.home.zip_code = '54321-5922' 
        self.assertEqual(self.home.zip_code, '54321-5922') 
