...
def string_to_date(date):
    ...
    try:
        ...
        # log the format error then rais ti again so it can be handled
        logging.error(e)
...
if __name__ == '__main__':
    parser = OptionParser()
    parser.add_option('-b', '--birthday', dest="birthday", action="store", help="Your birthday in MM-DD-YYYY format")
